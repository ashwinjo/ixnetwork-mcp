...
@mcp.tool()
def connect_ports(api_server_ip: str, 
                  session_id: str, 
                  port_list: List[Tuple[str,str,str]]) -> str:
    """
...
def start_traffic(api_server_ip: str, session_id: str, traffic_item_name: Optional[str] = None) -> str:
    ...
    Args:
        api_server_ip (str): IP address of the IxNetwork chassis
        session_id (str): ID of the session
        traffic_item_name (str, optional): Name of specific traffic item to start
...
if __name__ == "__main__":
    ...
    try: 
        ...
        #a = get_traffic_stats(api_server_ip='10.36.236.121', session_id='106', statistics_name='Traffic Item Statistics')
        #print(a)
        mcp.run()
    except Exception as e:
